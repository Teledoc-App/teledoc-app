					...
					<div className="flex  items-center w-[400px]">
						<div className="flex items-center">
							...
							>
								<circle cx="22.5" cy="22.5" r="22.5" fill="#FF5757" />
								<path
									d="M23 12C28.5228 12 33 16.4771 33 22C33 27.5228 28.5228 32 23 32C17.4771 32 13 27.5228 13 22H15C15 26.4183 18.5817 30 23 30C27.4183 30 31 26.4183 31 22C31 17.5817 27.4183 14 23 14C20.2502 14 17.8245 15.3873 16.3845 17.5002L19 17.5V19.5H13V13.5H15L14.9999 15.9992C16.8243 13.5707 19.7287 12 23 12ZM24 17L23.9998 21.585L27.2426 24.8284L25.8284 26.2426L21.9998 22.413L22 17H24Z"
									fill="white"
								/>
							</svg>

							<div className="ml-5">
								<h1 className="text-[#000000] text-xl font-bold">History</h1>
							</div>
						</div>
					</div>
				</Link>
