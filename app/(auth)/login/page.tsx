...
const Page = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-center w-screen h-screen px-4 bg-white">
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="w-full max-w-[400px] flex flex-col items-center gap-4 py-4 overflow-y-scroll">
      <h1 className="text-[#ff5757] text-4xl font-bold">Sign In</h1>
        ...
        <Button className='bg-[#ff5757] text-white rounded-lg w-full h-[60px] font-semibold mt-8' type='submit'>
          Sign in
        </Button>
      </form>
        <GoogleSignInButton>
